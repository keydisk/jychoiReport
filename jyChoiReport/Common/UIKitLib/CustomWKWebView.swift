...
class CustomWKWebView: WKWebView, WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler {
    ...
    @objc(setWebviewDelegate:)
    func setWebviewDelegate(delegate: CustomWKWebViewDelegate) {
    ...
    init(frame: CGRect, configuration: WKWebViewConfiguration, isNavigationGestrue: Bool = false) {
...
//                debugPrint("error : \(error)")
    ...
    @objc(requestUrl:)
    public func requestUrl(requestUrl: NSString) {
        
        guard let url = self.getUrl(requestUrl as String, urlEncoding: true) else {
            return
        }
        
        self.firstCallUrl = url.absoluteString
        
        var request = URLRequest(url: url, cachePolicy: .useProtocolCachePolicy , timeoutInterval: self.networkTimeout)
        request.httpShouldHandleCookies = true
...
//    func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Swift.Void) {
    ...
    func webView(_ webView: WKWebView, runJavaScriptAlertPanelWithMessage message: String, initiatedByFrame frame: WKFrameInfo, completionHandler: @escaping () -> Swift.Void) {
        ...
        let confirm = UIAlertAction(title: "확인", style: .default, handler: {handler in
            completionHandler()
        })
    ...
    func webView(_ webView: WKWebView, runJavaScriptConfirmPanelWithMessage message: String, initiatedByFrame frame: WKFrameInfo, completionHandler: @escaping (Bool) -> Swift.Void)
    {
        ...
        let cancel = UIAlertAction(title: "취소", style: .cancel, handler: {handler in
